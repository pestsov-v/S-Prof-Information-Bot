...
# **Оглавление**
  ...
  - [Функции](#функции)
    - [Найти проект](#найти-проект)
        - [получение](#)
            - [Первый шаг. Кнопка "Проекты"](#Первый-шаг.-Нажимай-на-кнопку-"Проекты".)
            - [Второй шаг. Выбор желаемого типа объекта](#Второй-шаг.-Выбираем-желаемый-тип-объекта.)
            - [Третий шаг. Вывод проекта по уникальному ID](#Третий-шаг.-Выводим-данным-исходя-из-уникального-ID-проекта-(uuid))
            - [Четвертый шаг. Отправка геопозиции](#Четвертый-шаг.-Отправляем-следующую-краткую-информацию-согласно-проекту)

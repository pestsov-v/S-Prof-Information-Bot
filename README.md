...
1. chat_id - обязательный параметр. Описан ранее.<br/>
2. file_id - обязательный параметр. Являет собой уникальный ID стикера, хранимый на серверах Telegram. Подробнее об file_id и методах отправки стикеров можно узнать в [официальной документации Telegram]()<br/>
